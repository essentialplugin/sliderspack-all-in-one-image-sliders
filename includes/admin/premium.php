...
<div class="wrap">
	...
	<h2><?php esc_html_e( 'SlidersPack Features', 'sliderspack-all-in-one-image-sliders' ); ?></h2><br />
				...
				<table class="wpos-plugin-pricing-table">
					...
					<thead>
						<tr>
							...
							<th>
								...
								<a href="<?php echo esc_url(WP_APAIOIS_PLUGIN_UPGRADE); ?>" target="_blank">Grab Now</a>
							</th>
						</tr>
					</thead>
					<tbody>
					...
					<tfoot>
						<tr>
							...
							<a href="<?php echo esc_url(WP_APAIOIS_PLUGIN_UPGRADE); ?>" target="_blank">Grab Now</a></td>
						</tr>
					</tfoot>
				</table>
			</div>
